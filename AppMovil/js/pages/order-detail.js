window.orderDetailPage = {
  ...
  async render(params) {
    ...
    return `
      <div class="flex-col mb-6" style="gap: 14px;">
        <button class="btn btn-secondary btn-sm" style="align-self: flex-start;" onclick="app.navigate('orders')">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><line x1="19" y1="12" x2="5" y2="12"/><polyline points="12 19 5 12 12 5"/></svg>
          Volver a Pedidos
        </button>

        <button class="btn btn-primary w-100" style="justify-content: center;" onclick="app.navigate('receipt', {id: ${this.orderId}})">
